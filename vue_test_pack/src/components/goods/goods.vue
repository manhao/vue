<template>
  <div class="goods">
     <div class="menu-wrapper" ref="menuwrapper">
     	 <ul>
     	 	 <li v-for="(item,index) in goods" class="menu_item" v-bind:class="currentIndex===index?'current':''" v-on:click="selectmune(index,$event)">
     	 	 	 <span class="text">
...
<style>
   ...
   .goods .menu-wrapper .menu_item.current{
      position: relative;
      z-index: 10;
      margin-top: -1px;
      background: #fff;
   ...
   .goods .menu-wrapper .menu_item.current .text{
      border:none;
   }
   .goods .menu-wrapper .icon{
	...
	.goods .menu-wrapper .icon.decrease{
	  	 background-image: url('decrease_3@2x.png');

	  }
	.goods .menu-wrapper .icon.discount{
	  	 background-image: url('discount_3@2x.png');

	  }
	.goods .menu-wrapper .icon.special{
	  	 background-image: url('special_3@2x.png');

	  }
	.goods .menu-wrapper .icon.invoice{
	  	 background-image: url('invoice_3@2x.png');

	  }
	 .goods .menu-wrapper .icon.guarantee{
   ...
   .goods .foods-wrapper .food-item .content .price .old{
    ...
    .goods .foods-wrapper .food-item .content .cartcontrol_wrapper{
      position: absolute;
      right:  0;
      bottom:12px;
   }
